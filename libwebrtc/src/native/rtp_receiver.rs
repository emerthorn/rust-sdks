...
impl RtpReceiver {
    /// VeilMesh (D6): see `crate::rtp_receiver::RtpReceiver::set_frame_transform`.
    pub fn set_frame_transform(
        ...
        match transform {
            Some(t) => ffi::set_receiver_frame_transform(
                self.sys_handle.clone(),
                Box::new(FrameTransformHandler::new(t)),
            ),
            None => ffi::clear_receiver_frame_transform(self.sys_handle.clone()),
        }
    }
